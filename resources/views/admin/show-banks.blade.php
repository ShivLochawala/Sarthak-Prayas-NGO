<x-app-layout>
    ...
    @section('content')
        ...
        <div class="w-100 bg-white shadow-md m-4 p-4">
            <div class="flex justify-between items-center">
                <h1 class="text-center" style="font-size:25px">Banks Added</h1>
                <button type="button" class="btn-outline-primary add_bank_modal px-4 bg-green-100 py-1 rounded hover:bg-green-200">Add Bank</button>
            </div>
                ...
                <div class="py-2 align-middle inline-block min-w-full sm:pl-6 lg:pl-8 ">
                    ...
                    <div class="shadow overflow-hidden border-b border-gray-200 sm:rounded-lg"> 
                        <table class="min-w-full divide-y divide-gray-200 text-center">
                            <thead>
                                <tr>
                                    <th class="pl-3 py-3 bg-gray-50 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Bank Name</th>
                                </tr>
                            </thead>
    ...
    @endsection
        @livewire('modal',['name'=>'bank_modal','btn_name'=>'add_bank_modal' ])
